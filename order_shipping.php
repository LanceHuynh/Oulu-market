					...
					<div class="sign-up">
						...
						<div class="sign-u">
							...
							<div class="sign-up2 form-group <?php echo (!empty($number_err)) ? 'has-error' : ''; ?>">
								<input type="number" name="number" placeholder="Your password" class="form-control" value="<?php echo $number; ?>" />
								<span class="help-block">
									<?php echo $number_err; ?>
								</span>
							</div>
						...
						<div class="sub_home">
							<div class="sub_home_left">
								...
								<input id="order" type="submit" name="shipping"  value="Confirm shipping" />
							</div>	
							<div class="clearfix"></div>
						</div>
